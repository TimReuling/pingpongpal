...
const translations = {
  en: {
    ...
    endMatch: 'End Match',
    endMatchRequest: 'wants to end the match',
    endMatchAccept: 'Accept',
    endMatchDecline: 'Continue',
    endMatchWaiting: 'Waiting for opponent…',
    endMatchExpired: 'End request expired',
    rematch: 'Rematch',
